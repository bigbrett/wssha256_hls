...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((1'b1 == grp_sha256_transform_fu_208_ap_ready)) begin
            ap_reg_grp_sha256_transform_fu_208_ap_start <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & ~(1'b0 == tmp_3_reg_641) & ~(~(1'b0 == tmp_3_reg_641) & (1'b0 == grp_sha256_transform_fu_208_ap_done)))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state3) & (1'b0 == tmp_3_fu_421_p2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & ~(~(1'b0 == tmp_3_reg_641) & (1'b0 == grp_sha256_transform_fu_208_ap_done)))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_start) & (ap_CS_fsm_state1 == 1'b1)) | ((1'b1 == ap_CS_fsm_state2) & ~(exitcond_fu_328_p2 == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & ~(exitcond_fu_328_p2 == 1'b0))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state5) & ~(1'b0 == tmp_3_reg_641))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) & ~(1'b0 == tmp_3_reg_641))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (~(exitcond_fu_328_p2 == 1'b0)) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else begin
        ...
        ap_ST_fsm_state5 : begin
            if (~(~(1'b0 == tmp_3_reg_641) & (1'b0 == grp_sha256_transform_fu_208_ap_done))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end
...
assign i_1_fu_333_p2 = (i_reg_197 + ap_const_lv7_1);

assign i_cast_fu_324_p1 = i_reg_197;

assign tmp_1_fu_410_p1 = ctx_datalen_fu_56;

assign tmp_2_fu_415_p2 = (ctx_datalen_fu_56 + ap_const_lv32_1);

assign tmp_3_fu_421_p2 = ((tmp_2_fu_415_p2 == ap_const_lv32_40) ? 1'b1 : 1'b0);

assign tmp_4_fu_469_p2 = ((ctx_bitlen_fu_96 > ap_const_lv32_FFFFFDFF) ? 1'b1 : 1'b0);

assign tmp_5_ctx_bitlen_1_fu_481_p3 = ((tmp_4_fu_469_p2[0:0] === 1'b1) ? tmp_5_fu_475_p2 : ctx_bitlen_1_fu_92);

assign tmp_5_fu_475_p2 = (ctx_bitlen_1_fu_92 + ap_const_lv32_1);

assign tmp_6_fu_489_p2 = (ctx_bitlen_fu_96 + ap_const_lv32_200);
